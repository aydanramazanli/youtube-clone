...
// searched videos
export const  SEARCHED_VIDEOS_REQUEST = 'RELATED_VIDEOS_REQUEST';
export const  SEARCHED_VIDEOS_FAIL = 'RELATED_VIDEOS_FAIL';
export const  SEARCHED_VIDEOS_SUCCESS = 'RELATED_VIDEOS_SUCCESS';
